...
describe('ArticlesService', () => {
  ...
  const tokenRepo = getRepositoryToken(Article);
  ...
  beforeEach(async () => {
    ...
    repository = module.get<Repository<Article>>(tokenRepo);
  });
  ...
  describe('findOne()', () => {
    ...
    it('should throw NotFoundException if article not exist', async () => {
      ...
      try {
        ...
        expect(e.response.message).toEqual('Article not found');
      }
    });
  });
